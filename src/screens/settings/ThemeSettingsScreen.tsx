...
export const ThemeSettingsScreen: React.FC<Props> = () => {
  ...
  const [useDynamicColors, setUseDynamicColors] = useState(false);
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            💡 Hinweis: Der Dark Mode wird aktuell entwickelt und steht bald zur
            Verfügung. Deine Auswahl wird gespeichert.
          </Text>
        </View>
      </ScrollView>
    </View>
